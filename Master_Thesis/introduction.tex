...
%To the best of our knowledge, this thesis provides the first evaluation of throughput of streaming data in lakehouse systems. We combine techniques from stream processing engine benchmarks and other lakehouse benchmarks.
